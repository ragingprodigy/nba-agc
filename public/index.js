...
(function() {
  angular.module('nbaAGC', ['ngCookies', 'ngResource', 'ngSanitize', 'ui.router', 'stormpath', 'stormpath.templates', 'ngMessages']).config([
    ...
    '$stormpath', function($stormpath) {
      return $stormpath.uiRouter({
        loginState: 'login',
  ...
  ]).controller('RegisterCtrl', ['$scope', function($scope) {}]).controller('NavbarCtrl', [
